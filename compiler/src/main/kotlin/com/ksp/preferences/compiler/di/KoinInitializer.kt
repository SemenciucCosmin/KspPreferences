package com.ksp.preferences.compiler.di

import com.google.devtools.ksp.processing.CodeGenerator
import com.google.devtools.ksp.processing.KSPLogger
import com.ksp.preferences.compiler.logger.Logger
import com.ksp.preferences.compiler.usecase.GenerateClearFunctionUseCase
import com.ksp.preferences.compiler.usecase.GenerateCompanionObjectUseCase
import com.ksp.preferences.compiler.usecase.GenerateFunctionUseCase
import com.ksp.preferences.compiler.usecase.GenerateGetFlowFunctionUseCase
import com.ksp.preferences.compiler.usecase.GenerateGetFunctionUseCase
import com.ksp.preferences.compiler.usecase.GenerateImplementationUseCase
import com.ksp.preferences.compiler.usecase.GenerateImportsUseCase
import com.ksp.preferences.compiler.usecase.GenerateSetFunctionUseCase
import com.ksp.preferences.compiler.usecase.GetPreferencesNameUseCase
import com.ksp.preferences.compiler.usecase.GetValueTypeAnnotationData
import com.ksp.preferences.compiler.usecase.ValidateClearFunctionDeclarationUseCase
import com.ksp.preferences.compiler.usecase.ValidateFunctionAnnotationsUseCase
import com.ksp.preferences.compiler.usecase.ValidateFunctionDeclarationUseCase
import com.ksp.preferences.compiler.usecase.ValidateGetFlowFunctionDeclarationUseCase
import com.ksp.preferences.compiler.usecase.ValidateGetFunctionDeclarationUseCase
import com.ksp.preferences.compiler.usecase.ValidateInterfaceUseCase
import com.ksp.preferences.compiler.usecase.ValidateSetFunctionDeclarationUseCase
