package com.ksp.preferences.compiler.logger
...
internal class Logger(private val logger: KSPLogger) {
    ...
    /**
     * Reports that a function annotated with [com.ksppreferences.annotations.Set] or
     * [com.ksppreferences.annotations.Clear] declares a non-Unit return type.
     *
     * @param interfaceName The simple name of the enclosing interface.
     * @param functionName  The simple name of the offending function.
    ...
    /**
     * Reports that the return type of a [com.ksppreferences.annotations.Get] or
     * [com.ksppreferences.annotations.GetFlow] function does not match the type declared
    ...
    /**
     * Reports that a [com.ksppreferences.annotations.GetFlow] function is mistakenly marked
    ...
    /**
     * Reports that the [com.ksppreferences.annotations.Preferences.name] parameter could not
